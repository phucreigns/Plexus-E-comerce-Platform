package com.phuc.review.exception;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiResponse<Object>> handleHttpMessageNotReadableException(HttpMessageNotReadableException exception) {
        ...
        if (exception.getMessage() != null && exception.getMessage().contains("end-of-input")) {
            message = "Request body is empty or incomplete. Please provide a valid JSON request body.";
        }
        return buildResponse(ErrorCode.INVALID_REQUEST_FORMAT, message);
    }
