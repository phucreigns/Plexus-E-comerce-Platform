...
public class CartServiceImpl implements CartService {
    ...
    private ErrorCode mapPromotionServiceError(FeignException e) {
            ...
            if (content != null && !content.isEmpty()) {
                ...
                if (errorResponse != null && errorResponse.getCode() != 0) {
                    ...
                    return switch (promotionErrorCode) {
                        case 2003 -> ErrorCode.PROMOTION_NOT_FOUND;
                        case 2004 -> ErrorCode.PROMOTION_EXPIRED;
                        case 2005 -> ErrorCode.PROMOTION_USAGE_LIMIT_REACHED;
                        case 2006 -> ErrorCode.CART_NOT_FOUND;
                        case 2008 -> ErrorCode.NO_ELIGIBLE_PRODUCTS;
                        case 2009 -> ErrorCode.PROMOTION_ORDER_VALUE_TOO_LOW;
                        case 1010 -> ErrorCode.PROMOTION_SERVICE_UNAVAILABLE;
                        default -> {
        ...
        if (e.status() == 404) {
            ...
            return ErrorCode.NO_ELIGIBLE_PRODUCTS;
